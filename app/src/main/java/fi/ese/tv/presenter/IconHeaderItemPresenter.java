...
public class IconHeaderItemPresenter extends RowHeaderPresenter {
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
        ...
        int iconId = R.drawable.android_header;

        if (headerItem instanceof MainHeaderItem) {
            iconId = ((MainHeaderItem) headerItem).getIconResId();
            if (iconId == -1)
                iconId = R.drawable.android_header;
        }
        try {
